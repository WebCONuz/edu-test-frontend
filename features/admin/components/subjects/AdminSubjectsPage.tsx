...
import type { Subject } from "@/features/teacher/types/teacher.types";

export function AdminSubjectsPage() {
  const { user } = useAuthStore();
  const { data: subjects, isLoading } = useFullSubjects();
          ...
          {subjects?.map((subject, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Admin barcha fanlarni o'zgartira oladi */}
